...
public class SoundRecordAndAnalysisActivity extends Activity implements OnClickListener{
    ...
    private class RecordAudio extends AsyncTask<Void, double[], Void> {
        ...
        public void onStart(){
            ...
            redDot.setStyle(Paint.Style.STROKE);
            redDot.setStrokeJoin(Paint.Join.ROUND);
            redDot.setStrokeCap(Paint.Cap.ROUND);
            redDot.setStrokeWidth(3);
...
//            }
            bitmapDisplaySpectrum = Bitmap.createBitmap((int)width,(int)1200,Bitmap.Config.ARGB_8888);
            ...
            if(width >512){
                ...
                //((MarginLayoutParams) layoutParams_imageViewDisplaySpectrum).setMargins(100, 100, 0, 0);
